...
# image-id: ami-0d7386f8f8e1d197e -> DLAMI Amazon Linux 2 20231213
aws ec2 run-instances --image-id ami-0d7386f8f8e1d197e --count 1 --instance-type g5.16xlarge --key-name your-key-pair-name --security-group-ids your-security-group-id --subnet-id your-subnet-id
